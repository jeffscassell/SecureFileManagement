...
<%@page import="java.util.LinkedList, java.util.ListIterator" %>
<!DOCTYPE html>
<html>
<head>
<style type="text/css">
...
<div align="center" class="fond">
    ...
    <div class="carre_couleur base_hov" style="background-color:#2ecc71;">
      ...
      <div class="acced">
		...
		<td><input type="text" name="downloadName" ondragenter="this.value=''" maxlength="150"></td>
    ...
    <div class="carre_couleur base_hov" style="background-color:#e74c3c;">
      ...
      <div class="acced">
		...
		<td><input type="text" name="deleteName" ondragenter="this.value=''" maxlength="150"></td>
